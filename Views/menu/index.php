...
<div class="pt-20">
    <h2 class="text-center text-4xl text-gray-800 font-bold">Menu</h2>
    ...
    <ul data-accordion="open" class="relative m-2 space-y-2">
        ...
        ?>
            <li class="space-y-2">
                <div id="li-category-heading-<?php echo $category->id_category ?>" aria-expanded="true" data-accordion-target="#list-product-<?php echo $category->id_category ?>" class="relative flex justify-between py-2 mx-4 space-x-4 border-dotted border-b-2 border-amber-400 text-gray-800 bg-orange-50 cursor-pointer">
                    <div class="h-10">
                        <h3 id="name_category" class="text-sm font-medium"><?php echo $category->name_category ?></h3>
                        <?php
                    ...
                    <div data-accordion-icon class="flex px-4 items-center text-sm">
                ...
                <div id="list-product-<?php echo $category->id_category ?>" class="flex flex-wrap flex-row justify-between items-center lg:after:content-[''] lg:after:basis-[32%] mx-4">
                    ...
                    foreach ($data['product'][$key_category] as $key => $product) {
                        if (!empty($product)) {
                    ?>
                            <div class="relative group flex flex-col justify-center items-center h-72 z-0 mb-10 basis-full bg-orange-100 lg:h-80 lg:basis-[32%] md:basis-[48%] md:mx-0">
                                <?php
