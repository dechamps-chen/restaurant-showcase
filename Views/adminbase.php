            ...
            <aside id="default-sidebar" class="border-r mt-16 fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="http://localhost/applications/projet-xbl/houtai" class="flex items-center p-2 pl-8 text-gray-900 bg-gray-300 hover:bg-gray-100 group">
                        ...
                        <li>
                            <a href="http://localhost/applications/projet-xbl/houtai/menu" class="flex items-center p-2 pl-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
